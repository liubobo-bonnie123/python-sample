...
def singleissue(issue_tuple, preview_dict):
  """ singleissue : tuple dict list list -> Issue object 
  Takes a single result tuple from a selection query and a dictionary of issue preview images
  and returns an equivalent Issue object.
  """
  issue = classes.Issue()
...
def listissues(issue_list, preview_dict):
  """ singleissue : list dict list list -> list
  Takes a list of result tuples from a selection query and a dictionary of issue preview images
  and returns a list of equivalent Issue objects.
  """
  issue_objects = []
